...
class UserChose {
	...
	foreach ($userList as $one)
	    ...
	    $historyUser = $this->em->getRepository('CreativeDataCroissantBundle:history')->findAllFromDateAndIdUser(date("Y-m-d 00:00:00", strtotime("-3 weeks")),date("Y-m-d 00:00:00", strtotime("+3 weeks")), $user->getId());
	    ...
	    $message = \Swift_Message::newInstance()
		    ...
		    ->setBody($this->template->render('CreativeDataCroissantBundle::email.txt.twig', array('user' => $user)))
		    ->addPart($this->template->render('CreativeDataCroissantBundle::email.html.twig', array('user' => $user)), "text/html");
